...
function quadro_admin_options_page() { 
	...
	<div class="wrap">
		...
		<?php if ( isset( $_GET['settings-updated'] ) ) {
				...
				echo __( 'Theme settings updated successfully.', 'quadro' );
				echo '</p></div>';
		} ?>
		...
		?>
			...
			<?php submit_button( __( 'Save Settings', 'quadro' ), 'primary', $quadro_options_group . '[submit-' . $currenttab . ']', false ); ?>
			<?php submit_button( __( 'Reset This Tab', 'quadro' ), 'secondary', $quadro_options_group . '[reset-' . $currenttab . ']', false ); ?>
		</form>
