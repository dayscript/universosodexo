...
function quadro_content_nav( $nav_id ) {
	...
	<?php elseif ( $wp_query->max_num_pages > 1 && ( is_home() || is_archive() || is_search() ) ) : // navigation links for home, archive, and search pages ?>
		...
		<div class="nav-previous"><span class="meta-nav">&larr;</span> <?php next_posts_link( __( 'Previous', 'quadro' ) ); ?></div>
		<?php endif; ?>

		<?php if ( get_previous_posts_link() ) : ?>
		<div class="nav-next"><?php previous_posts_link( __( 'Next', 'quadro' ) ); ?> <span class="meta-nav">&rarr;</span></div>
		<?php endif; ?>
...
function quadro_paging_nav( $older = '&larr;', $newer = '&rarr;' ) {
	...
	<nav class="navigation paging-navigation clear" role="navigation">
		...
		<div class="nav-links">
			...
			<?php if ( get_next_posts_link() ) : ?>
			<div class="nav-previous"><span class="meta-nav"><?php next_posts_link( $older . ' ' . __( 'Older posts', 'quadro' ) ); ?></span></div>
			<?php endif; ?>

			<?php if ( get_previous_posts_link() ) : ?>
			<div class="nav-next"><span class="meta-nav"><?php previous_posts_link( __( 'Newer posts', 'quadro' ) . ' ' . $newer ); ?></span></div>
			<?php endif; ?>
...
function quadro_post_nav( $older = '&larr;', $newer = '&rarr;', $thumb_size = 'medium' ) {
	...
	<nav class="navigation post-navigation clear" role="navigation">
		...
		<div class="nav-links">
			...
			previous_post_link( '<div class="nav-previous">%link</div>' , $prev_thumb . '<span class="meta-nav"><strong>' . __( 'Previous:', 'quadro' ) . '</strong>' . $older . ' %title</span>' );
			next_post_link( '<div class="nav-next">%link</div>', $next_thumb . '<span class="meta-nav"><strong>' . __( 'Next:', 'quadro' ) . '</strong>%title ' . $newer . '</span>' );
			?>
		</div><!-- .nav-links -->
	</nav><!-- .navigation -->
	<?php
...
function quadro_posted_by_gravatar( $author_ID, $g_size = 30 ) {
	...
	echo '<div class="byline">';
		...
		printf( __( '<span>by %1$s</span>', 'quadro' ),
			sprintf( '<span class="author vcard"><a class="url fn n" href="%1$s" title="%2$s">%3$s</a></span>',
				$author_link,
				esc_attr( sprintf( __( 'View all posts by %s', 'quadro' ), get_the_author() ) ),
				esc_html( get_the_author() )
