...
function quadro_woocommerce_page_header() {
	...
	$header_style 	= ($back_color != '#' && $back_color != '') || ($header_use_pic == 'true' && has_post_thumbnail($page_id)) ? 'colored-header' : '';
	// $header_style 	= $back_color > 2 ? 'colored-header' : '';
	?>
...
function quadro_woocomerce_header_cart_refresh( $fragments ) {
	...
	<div class="header-cart">
		<?php if( !$woocommerce->cart->cart_contents_count ) { ?>
			<a class="header-cart-link" href="<?php echo get_permalink( get_option('woocommerce_cart_page_id') ); ?>"><i class="fa fa-shopping-cart"></i></a>
			<div class="cart-contents">
				<p class="cart-empty-msg"><?php _e('You have no items in your cart.', 'quadro') ?></p>
			</div>
		<?php } else { ?>
			<a class="header-cart-link header-cart-link-active" href="<?php echo get_permalink( get_option('woocommerce_cart_page_id') ); ?>"><i class="fa fa-shopping-cart"></i><span><?php echo $woocommerce->cart->cart_contents_count; ?></span></a>
			<div class="cart-contents">
				<ul>
				...
				<div class="cart-total">
					<p><?php echo __('Cart Subtotal ', 'quadro') . '<span>' . $woocommerce->cart->get_cart_total() . '</span>'; ?></p>
				</div>
				<div class="cart-actions">
					<div class="cart-link"><a href="<?php echo get_permalink( get_option('woocommerce_cart_page_id') ); ?>" title="<?php _e('View Cart', 'quadro'); ?>"><?php _e('View Cart', 'quadro'); ?></a></div>
					<div class="checkout-link"><a href="<?php echo get_permalink( get_option('woocommerce_checkout_page_id') ); ?>" title="<?php _e('Checkout', 'quadro'); ?>"><?php _e('Checkout', 'quadro'); ?></a></div>
				</div>
			</div>
		<?php } ?>
	</div>
...
function quadro_header_cart() {
	...
	<?php } // End if Show Cart in header conditional
}
