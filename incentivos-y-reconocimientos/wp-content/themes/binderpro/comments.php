...
<div id="comments" class="comments-area">
	...
	<?php if ( have_comments() ) : ?>
		...
		<nav id="comment-nav-below" class="comment-navigation clear" role="navigation">
			<h1 class="screen-reader-text"><?php _e( 'Comment navigation', 'quadro' ); ?></h1>
			<div class="nav-previous"><?php previous_comments_link( __( '&larr; Older Comments', 'quadro' ) ); ?></div>
			<div class="nav-next"><?php next_comments_link( __( 'Newer Comments &rarr;', 'quadro' ) ); ?></div>
	...
	?>
		<p class="no-comments"><?php _e( 'Comments are closed.', 'quadro' ); ?></p>
	<?php endif; ?>

	<?php $comment_defaults = array(
		'comment_notes_after'  	=> '',
		'title_reply'          	=> __( 'Leave a Comment', 'quadro' ),
		'title_reply_to'       	=> __( 'Leave a Reply to %s', 'quadro' ),
	); ?>
