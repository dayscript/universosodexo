			...
			case 'gallery':
				if ( get_post_gallery() ) {
					...
					if ( isset($gallery['ids']) ) {
						...
						$content = quadro_strip_shortcode_gallery( get_the_content( '<span class="read-more">' . __('Read more', 'quadro') . '</span>' ) );
						...
						$content = get_the_content( '<span class="read-more">' . __('Read more', 'quadro') . '</span>' );
					}
				} else {
