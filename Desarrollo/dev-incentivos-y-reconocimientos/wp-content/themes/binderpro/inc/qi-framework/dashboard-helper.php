...
function quadro_toolbar( $wp_admin_bar ) {
	...
	$args = array(
		...
		'title' => 'WordPress Training Videos',
		'parent' => 'quadro_toolbar',
...
function quadro_admin_pointers() {
	...
	$new_pointer_content = '<h3>' . __( 'Theme Shortcuts', 'quadro' ) . '</h3>';
	$new_pointer_content .= '<p>' . __( 'Easily access your Theme Options, Docs or Support by selecting from this drop down menu.', 'quadro' ) . '</p>';
