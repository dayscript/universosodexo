			...
			<article id="post-<?php the_ID(); ?>" <?php post_class('featured-item clear feat-' . $feat_layout); ?>>
				...
				<div class="feat-item-content">
					...
					<div class="feat-item-text">
						...
						if ( $post_format == 'video' || $post_format == 'audio' ) echo quadro_excerpt($media_return['content'], 40, '<span class="read-more">' . __('Read more', 'quadro') . '</span>');
						elseif ( $post_format == 'gallery' ) echo quadro_excerpt($content, 40, '<span class="read-more">' . __('Read more', 'quadro') . '</span>');
						...
						else quadro_excerpt(get_the_excerpt(), 40, '<span class="read-more">' . __('Read more', 'quadro') . '</span>');
						?>
					</div>
				</div>
